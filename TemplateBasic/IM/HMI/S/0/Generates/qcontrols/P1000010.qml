...
IGuiPage
{
	...
	IGuiAlarmView
	{
		...
		IGuiListCtrl
		{
			...
			totalColumnWidth: 1023
			qm_headerItem: qh402653203
			IGuiListHeader
			{
				id: qh402653203
				width: 1023
				qm_listItem: qu402653203
				qm_columnWidthList: [30, 84, 84, 102, 723]
				color: "#ffefebef"
	...
	IGuiGraphicTextButton
	{
		...
		height: 94
		qm_Transparent : true 
		qm_TextColor: "#ff181818"
		qm_TextValueVarTextAlignmentHorizontal: Text.AlignHCenter
		qm_TextValueVarTextAlignmentVertical: Text.AlignBottom
		qm_FocusWidth: 2
